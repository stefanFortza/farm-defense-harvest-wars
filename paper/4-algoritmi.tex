...
\begin{itemize}
    ...
    \item \textbf{Comunicarea Inter-Procese (IPC):} La finalizarea jocului, instanța Headless comunică înapoi cu backend-ul ASP.NET Core printr-un apel HTTP autentificat. Raportarea rezultatului este validată folosind (\texttt{MatchServerCallbackKey}), asigurând integritatea tranzacției de acordare a recompenselor (bani, experiență).
