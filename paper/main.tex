...
% Capitolul 1: Viziunea și povestea jocului
\include{1-introducere}

% Capitolul 2: Godot, C-Sharp, .NET 10, SQLite, Ubuntu
\include{2-tehnologii}

% Capitolul 3: Client-Server, Entity Framework, State Pattern, Component Pattern
\include{3-arhitectura}

% Capitolul 4: Matchmaking, Grid, Sistemul de Combat
\include{4-algoritmi}

% Capitolul 5: Input, UI, HUD
\include{5-interfata}

% Capitolul 6: Task-uri realizate și dezvoltări viitoare
\include{6-concluzii}
