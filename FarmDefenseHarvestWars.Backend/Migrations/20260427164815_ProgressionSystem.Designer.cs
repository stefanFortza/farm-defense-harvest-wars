...
namespace FarmDefenseHarvestWars.Backend.Migrations
{
    ...
    [Migration("20260427164815_ProgressionSystem")]
    partial class ProgressionSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FarmDefenseHarvestWars.Backend.Models.MatchResult", b =>
                {
                    ...
                    b.Property<string>("AttackerDroppedChestJson")
                        .HasColumnType("TEXT");

                    b.Property<int>("AttackerGoldEarned")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DefenderDroppedChestJson")
                        .HasColumnType("TEXT");

                    b.Property<int>("DefenderGoldEarned")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FarmDefenseHarvestWars.Backend.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
